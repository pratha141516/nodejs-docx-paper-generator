...
export type CommandClass = new (inputs?: string[], option?: object, args?: UserArg) => any;
export interface CommandParams {
    name: string;
    alias?: string;
    description?: string;
}
export type OptionType = BooleanConstructor | StringConstructor | NumberConstructor | [StringConstructor] | ArrayConstructor;

...
const commandFactory = (commandParams) => target => {
    ...
    Reflect.defineMetadata(metadata_1.metadata.COMMAND_IDENTIFIER, Object.assign({}, commandParams), target);
    Reflect.defineMetadata(metadata_1.metadata.HANDLER_IDENTIFIER, metadata_1.handlers.COMMAND, target);
};
const Command = (commandParams) => commandFactory(commandParams);
